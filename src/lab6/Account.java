...
public class Account {
	...
	public static Consumer<Account> add100 = (account)->{account.balance = account.balance+100;};
	...
	// TODO: Task3 
	// replace the null with a lambda expression
	public static AddMaker maker = amt -> (Consumer<Account>)x -> {x.balance = x.balance+amt; };
	...
	public static int getMaxAccountID(List<Account> accounts) {
		// TODO: Task4 
		// replace the null with a lambda expression
		Account maxOne = accounts.stream().reduce(new Account(0, -100), (account, account2)->account.balance>account2.balance?account:account2);
